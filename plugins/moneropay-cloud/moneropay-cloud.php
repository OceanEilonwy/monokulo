<?php
/**
 * Plugin Name:       MoneroPay Cloud for WooCommerce
 * Plugin URI:        https://github.com/moneropay-cloud/moneropay-core
 * Description:       Accept Monero at checkout via MoneroPay Cloud, the hosted,
 *                     non-custodial payment gateway built on moneropay-core.
 ...
 * Author:             MoneroPay Cloud
 * Author URI:         https://github.com/moneropay-cloud
 * License:            GPL-2.0-or-later
 * License URI:        https://www.gnu.org/licenses/gpl-2.0.html
 * Text Domain:         moneropay-cloud
 ...
 * entire job is making "Monero (via MoneroPay Cloud)" appear in WooCommerce's
 ...
 * the Rust engine (`moneropay-core`) per `docs/WOOCOMMERCE_ROADMAP.md` Stage 7's
 ...
 * this file for a concrete reason, not just convention: `WC_Gateway_MoneroPay`
 * (in includes/class-wc-gateway-moneropay.php) `extends WC_Payment_Gateway`,
 ...
 */
function moneropay_cloud_init_gateway_class() {
	...
	require_once __DIR__ . '/includes/class-wc-gateway-moneropay.php';
}
add_action( 'plugins_loaded', 'moneropay_cloud_init_gateway_class' );

/**
 * Adds `WC_Gateway_MoneroPay` to WooCommerce's list of available gateway
 ...
 */
function moneropay_cloud_add_gateway_class( $gateways ) {
	$gateways[] = 'WC_Gateway_MoneroPay';
	return $gateways;
}
add_filter( 'woocommerce_payment_gateways', 'moneropay_cloud_add_gateway_class' );
