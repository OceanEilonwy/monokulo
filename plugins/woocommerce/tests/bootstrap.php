<?php
/**
 * PHPUnit bootstrap for the Monokulo WooCommerce plugin.
 *
 ...
 * `wp_options` row saying "monokulo is active" for the test run to
 ...
 * `monokulo.php`'s own `plugins_loaded` hook exists in production:
 * `WC_Gateway_Monokulo extends WC_Payment_Gateway`, a class WooCommerce
 ...
 * own job (both plugins are "active", and `monokulo.php` additionally
 ...
 */
function _monokulo_manually_load_plugins() {
	...
	require dirname( __DIR__ ) . '/monokulo.php';
}
