...
//! (`[exchange_rate]` config) - two implementations of the provider trait exist:
//! `FixedRateProvider`, useful for a self-hoster who wants to peg a rate manually
//! (or for testing), and `CoingeckoRateProvider`, which fetches live rates from
//! Coingecko's public API (WBS 1.7.1).
//!
